...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <h3 class="fs-4 fw-bold text-danger">Price: $ ${product.price}</h3>
      <p><small><i class="far fa-star text-warning"></i> ${product?.rating?.rate}/5  <i class="far fa-user text-warning"></i> ${product?.rating?.count}</small></p>
...
// Increase added product counts function
let count = 0;
